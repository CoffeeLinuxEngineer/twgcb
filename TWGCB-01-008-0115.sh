#!/bin/bash
# TWGCB-01-008-0115: All interfaces must ignore secure ICMP redirects (RHEL 8.5)
# Requirement: net.ipv4.conf.all.secure_redirects = 0 (persistent) and runtime value = 0
...
TITLE="TWGCB-01-008-0115: Block secure ICMP redirects on all interfaces (all.secure_redirects=0)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0115.conf"
...
check_compliance() {
  echo "Checking secure_redirects (all interfaces) ..."
  echo "Check results:"
  show_check_lines
