#!/bin/bash
# TWGCB-01-008-0116: Default interface must ignore secure ICMP redirects (RHEL 8.5)
# Requirement: net.ipv4.conf.default.secure_redirects = 0 (persistent) and runtime value = 0
...
TITLE="TWGCB-01-008-0116: Block secure ICMP redirects on default interface (secure_redirects=0)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0116.conf"
...
check_compliance() {
  echo "Checking secure_redirects (default interface) ..."
  echo "Check results:"
  show_check_lines
