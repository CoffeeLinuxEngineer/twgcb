#!/bin/bash
#
# TWGCB-01-008-0216: Minimum number of different characters from old password
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces difok=3 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0216: Minimum number of different characters from old password"
