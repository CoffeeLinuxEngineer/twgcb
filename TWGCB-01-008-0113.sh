#!/bin/bash
# TWGCB-01-008-0113: All interfaces must ignore ICMP redirects (IPv4 & IPv6) on RHEL 8.5
# Requirement: net.ipv4.conf.all.accept_redirects = 0 AND net.ipv6.conf.all.accept_redirects = 0
...
TITLE="TWGCB-01-008-0113: Block ICMP redirects on all interfaces (IPv4 & IPv6)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0113.conf"
KEY4="net.ipv4.conf.all.accept_redirects"
KEY6="net.ipv6.conf.all.accept_redirects"
REQUIRED_VALUE="0"
...
check_compliance() {
  echo "Checking ICMP redirects (all interfaces, IPv4 & IPv6) ..."
  echo "Check results:"
  show_check_lines
