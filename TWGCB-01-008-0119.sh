#!/bin/bash
# TWGCB-01-008-0119: Do not respond to ICMP broadcast requests (RHEL 8.5)
# Requirement: net.ipv4.icmp_echo_ignore_broadcasts = 1 (persistent) and runtime value = 1
...
TITLE="TWGCB-01-008-0119: Ignore ICMP broadcast requests (icmp_echo_ignore_broadcasts=1)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0119.conf"
...
check_compliance() {
  echo "Checking ICMP broadcast response behavior ..."
  echo "Check results:"
  show_check_lines
