#!/bin/bash
#
# TWGCB-01-008-0217: Limit repeated characters of the same class in passwords
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces maxclassrepeat=4 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0217: Limit repeated characters of the same class in passwords"
