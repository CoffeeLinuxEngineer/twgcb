#!/bin/bash
# TWGCB-01-008-0200: Ensure /etc/cron.weekly directory permissions
# Target OS: RHEL 8.5
...
echo "TWGCB-01-008-0200: Ensure /etc/cron.weekly directory permissions"
...
if check_compliance; then
    echo -e "${CLR_GREEN}Compliant: /etc/cron.weekly permissions are 700 or stricter.${CLR_RESET}"
    exit 0
else
    echo -e "${CLR_RED}Non-compliant: /etc/cron.weekly permissions too permissive or directory missing.${CLR_RESET}"
fi
