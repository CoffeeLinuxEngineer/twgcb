#!/bin/bash
# TWGCB-01-008-0108: Disable IP forwarding (IPv4 & IPv6) on RHEL 8.5
# Requirement: net.ipv4.ip_forward = 0 AND net.ipv6.conf.all.forwarding = 0, both persisted and zero at runtime.
...
TITLE="TWGCB-01-008-0108: Disable IP forwarding (IPv4 & IPv6)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0108.conf"
KEY4="net.ipv4.ip_forward"
KEY6="net.ipv6.conf.all.forwarding"
REQUIRED_VALUE="0"
...
check_compliance() {
  echo "Checking IP forwarding (IPv4 & IPv6) ..."
  echo "Check results:"
  show_check_lines
