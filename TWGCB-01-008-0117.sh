#!/bin/bash
# TWGCB-01-008-0117: All interfaces log suspicious packets (RHEL 8.5)
# Requirement: net.ipv4.conf.all.log_martians = 1 (persistent) and runtime value = 1
...
TITLE="TWGCB-01-008-0117: Log suspicious packets on all interfaces (log_martians=1)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0117.conf"
...
check_compliance() {
  echo "Checking log_martians (all interfaces) ..."
  echo "Check results:"
  show_check_lines
