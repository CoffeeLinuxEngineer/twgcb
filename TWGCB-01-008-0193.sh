#!/bin/bash
# TWGCB-01-008-0193: Ensure /etc/crontab file ownership
# Target OS: RHEL 8.5
...
echo "TWGCB-01-008-0193: Ensure /etc/crontab file ownership"
...
if check_compliance; then
    echo -e "${CLR_GREEN}Compliant: /etc/crontab owned by root:root.${CLR_RESET}"
    exit 0
else
    echo -e "${CLR_RED}Non-compliant: /etc/crontab ownership incorrect or file missing.${CLR_RESET}"
fi
