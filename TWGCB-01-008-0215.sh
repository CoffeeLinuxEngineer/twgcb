#!/bin/bash
#
# TWGCB-01-008-0215: Minimum number of special characters in password
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces ocredit=-1 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0215: Minimum number of special characters in password"
