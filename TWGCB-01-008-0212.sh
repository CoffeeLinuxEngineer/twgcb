#!/bin/bash
#
# TWGCB-01-008-0212: Minimum number of digits in password
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces dcredit=-1 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0212: Minimum number of digits in password"
