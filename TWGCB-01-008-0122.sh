#!/bin/bash
# TWGCB-01-008-0122: Enable reverse path filtering on default interface (RHEL 8.5)
# Requirement: net.ipv4.conf.default.rp_filter = 1 (persistent) and runtime value = 1
...
TITLE="TWGCB-01-008-0122: Enable reverse path filtering (default.rp_filter=1)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0122.conf"
...
check_compliance() {
  echo "Checking reverse path filtering (default interface) ..."
  echo "Check results:"
  show_check_lines
