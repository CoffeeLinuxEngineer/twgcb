#!/bin/bash
#
# TWGCB-01-008-0213: Minimum number of uppercase letters in password
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces ucredit=-1 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0213: Minimum number of uppercase letters in password"
