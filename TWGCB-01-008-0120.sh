#!/bin/bash
# TWGCB-01-008-0120: Ignore bogus ICMP error responses (RHEL 8.5)
# Requirement: net.ipv4.icmp_ignore_bogus_error_responses = 1 (persistent) and runtime value = 1
...
TITLE="TWGCB-01-008-0120: Ignore bogus ICMP error responses (icmp_ignore_bogus_error_responses=1)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0120.conf"
...
check_compliance() {
  echo "Checking bogus ICMP error response handling ..."
  echo "Check results:"
  show_check_lines
