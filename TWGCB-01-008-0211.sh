#!/bin/bash
#
# TWGCB-01-008-0211: Minimum number of character classes in password
# Target OS: Red Hat Enterprise Linux 8.5
# This script checks and enforces minclass=4 in /etc/security/pwquality.conf
...
echo "TWGCB-01-008-0211: Minimum number of character classes in password"
