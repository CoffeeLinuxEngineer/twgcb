#!/bin/bash
# TWGCB-01-008-0123: Enable TCP SYN cookies (RHEL 8.5)
# Requirement: net.ipv4.tcp_syncookies = 1 (persistent) and runtime value = 1
...
TITLE="TWGCB-01-008-0123: Enable TCP SYN cookies (tcp_syncookies=1)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0123.conf"
...
apply_fix() {
  ...
  case "${ans}" in
    Y|y)
      ...
      # Flush IPv4 routes as in baseline guidance
