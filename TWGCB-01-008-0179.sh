#!/bin/bash
# TWGCB-01-008-0179: Ensure /var/log directory ownership
# Target OS: RHEL 8.5
...
echo "TWGCB-01-008-0179: Ensure /var/log directory ownership"
...
if check_compliance; then
    echo -e "${CLR_GREEN}Compliant: /var/log owned by root:root.${CLR_RESET}"
    exit 0
else
    echo -e "${CLR_RED}Non-compliant: /var/log ownership incorrect or directory missing.${CLR_RESET}"
fi
