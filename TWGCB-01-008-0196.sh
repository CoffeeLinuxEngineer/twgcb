#!/bin/bash
# TWGCB-01-008-0196: Ensure /etc/cron.hourly directory permissions
# Target OS: RHEL 8.5
...
echo "TWGCB-01-008-0196: Ensure /etc/cron.hourly directory permissions"
...
if check_compliance; then
    echo -e "${CLR_GREEN}Compliant: /etc/cron.hourly permissions are 700 or stricter.${CLR_RESET}"
    exit 0
else
    echo -e "${CLR_RED}Non-compliant: /etc/cron.hourly permissions too permissive or directory missing.${CLR_RESET}"
fi
