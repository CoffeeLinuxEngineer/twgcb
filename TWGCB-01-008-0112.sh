#!/bin/bash
# TWGCB-01-008-0112: Default interface must ignore source-routed packets (IPv4 & IPv6) on RHEL 8.5
# Requirement: net.ipv4.conf.default.accept_source_route = 0 AND net.ipv6.conf.default.accept_source_route = 0
...
TITLE="TWGCB-01-008-0112: Block source-routed packets on default interface (IPv4 & IPv6)"
GREEN="\e[1;92m"   # bright green
RED="\e[1;91m"     # bright red
YELLOW="\e[1;33m"
RESET="\e[0m"

PERSIST_FILE="/etc/sysctl.d/99-twgcb-0112.conf"
KEY4="net.ipv4.conf.default.accept_source_route"
KEY6="net.ipv6.conf.default.accept_source_route"
REQUIRED_VALUE="0"
...
check_compliance() {
  echo "Checking source-routed packet acceptance (default interface, IPv4 & IPv6) ..."
  echo "Check results:"
  show_check_lines
